...
public class AnswerScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //quizManager = GameObject.Find("QuizManager (1)");
    }
    ...
    public void Answer()
    {
        ...
        else
        {
            ...
            if (quizManager.options[0].GetComponent<AnswerScript>().isCorrect == true)
            {
                GameObject.Find("A").GetComponent<Image>().color = Color.green;
            }
            else if (quizManager.options[1].GetComponent<AnswerScript>().isCorrect == true)
            {
                GameObject.Find("B").GetComponent<Image>().color = Color.green;
            }
            else if (quizManager.options[2].GetComponent<AnswerScript>().isCorrect == true)
            {
                GameObject.Find("C").GetComponent<Image>().color = Color.green;
            }
            else if (quizManager.options[3].GetComponent<AnswerScript>().isCorrect == true)
            {
